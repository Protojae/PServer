...
public class NPC extends Entity {
    ...
    public static NPC of(int id, Tile tile) {
        switch (id) {
            case NpcIdentifiers.COMBAT_DUMMY:
                return new MaxHitDummyNpc(id, tile);
            case NpcIdentifiers.UNDEAD_COMBAT_DUMMY:
                return new UndeadMaxHitDummy(id, tile);
            case Wyrm.IDLE:
            case Wyrm.ACTIVE:
                return new Wyrm(id, tile);
            case 8609:
                return new Hydra(id, tile);
            case 8612:
            case 8613:
                return new Drake(id, tile);
            case NpcIdentifiers.TZTOKJAD:
                return new TzTokJad(id, tile);
            case NpcIdentifiers.DEMONIC_GORILLA:
            case NpcIdentifiers.DEMONIC_GORILLA_7145:
            case NpcIdentifiers.DEMONIC_GORILLA_7146:
                return new DemonicGorilla(id, tile);
            case NpcIdentifiers.CORRUPTED_HUNLLEF:
            case NpcIdentifiers.CORRUPTED_HUNLLEF_9036:
            case NpcIdentifiers.CORRUPTED_HUNLLEF_9037:
                return new CorruptedHunleff(id, tile);
            default:
